...
class GetTaskViewTaskDetailsRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Workflow\StructType\TaskOverviewCriteria $taskOverviewCriteria = null, array $midocoTaskViewColumns = [], ?bool $isCounterOnly = false)
    {
        $this
