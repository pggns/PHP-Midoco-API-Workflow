...
class ListTaskDetailsRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Workflow\StructType\ListTaskDetailsCriteria $listTaskDetailsCriteria = null, array $midocoTaskViewColumns = [], ?bool $isCounterOnly = false, ?int $maxRowCount = 1000)
    {
        $this
