...
class UserDataSaveGUIPropertiesRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty[]
     */
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty[] $userDataGUIProperty
     */
     ...
     * @return \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty[]
     */
    ...
    public static function validateUserDataGUIPropertyForArrayConstraintFromSetUserDataGUIProperty(?array $values = []): string
    {
        ...
        foreach ($values as $userDataSaveGUIPropertiesRequestUserDataGUIPropertyItem) {
            ...
            if (!$userDataSaveGUIPropertiesRequestUserDataGUIPropertyItem instanceof \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The UserDataGUIProperty property can only contain items of type \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty[] $userDataGUIProperty
     * @return \Pggns\MidocoApi\Workflow\StructType\UserDataSaveGUIPropertiesRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty $item
     * @return \Pggns\MidocoApi\Workflow\StructType\UserDataSaveGUIPropertiesRequest
     */
    public function addToUserDataGUIProperty(\Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty) {
            throw new InvalidArgumentException(sprintf('The UserDataGUIProperty property can only contain items of type \Pggns\MidocoApi\Workflow\StructType\UserDataGUIProperty, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
