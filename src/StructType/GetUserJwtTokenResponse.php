...
class GetUserJwtTokenResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO[]
     */
    ...
    public static function validateMidocoUserJwtTokenForArrayConstraintFromSetMidocoUserJwtToken(?array $values = []): string
    {
        ...
        foreach ($values as $getUserJwtTokenResponseMidocoUserJwtTokenItem) {
            ...
            if (!$getUserJwtTokenResponseMidocoUserJwtTokenItem instanceof \Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUserJwtToken property can only contain items of type \Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO[] $midocoUserJwtToken
     * @return \Pggns\MidocoApi\Workflow\StructType\GetUserJwtTokenResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO $item
     * @return \Pggns\MidocoApi\Workflow\StructType\GetUserJwtTokenResponse
     */
    public function addToMidocoUserJwtToken(\Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUserJwtToken property can only contain items of type \Pggns\MidocoApi\Workflow\StructType\UsersJwtTokenDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
