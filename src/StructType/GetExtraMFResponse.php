...
class GetExtraMFResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getExtraMFResponseMidocoMfItem) {
            ...
            if (!$getExtraMFResponseMidocoMfItem instanceof \Pggns\MidocoApi\Workflow\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Workflow\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Workflow\StructType\GetExtraMFResponse
     */
